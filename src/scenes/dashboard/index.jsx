...
const Dashboard = () => {
  ...
  // ✅ Function to download mockTransactions as CSV
  const handleDownloadReport = () => {
    const csvHeader = "Transaction ID,User,Date,Cost\n";
    const csvRows = mockTransactions.map(
      (tx) => `${tx.txId},${tx.user},${tx.date},${tx.cost}`
    );
